// Global scan hits organized by category so prompt generation can sample
// across categories (guaranteeing varied innovation mixes per scenario).
export const globalScanHitCategories = {
...
// Technology-centric categories — scenario specs limit these to at most one
// per scenario so innovation mixes don't collapse into AI + VR every time.
...
// Flat list preserved for backward compatibility (regeneration prompt, etc.)
export const globalScanHits = Object.values(globalScanHitCategories).flat();
